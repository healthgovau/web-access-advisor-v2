  ...
  const phases = getPhaseStatuses();  const getStatusIcon = (status: PhaseStatus['status'], phase: string) => {
    ...
    switch (status) {
      ...
      case 'active':
        ...
        if (phase === 'ai') {
          return (
            <svg className={`${iconClass} ai-pulse`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="card rounded-lg p-4">
      <h2 className="text-xl font-medium text-brand-dark mb-6">Testing Phase</h2>
